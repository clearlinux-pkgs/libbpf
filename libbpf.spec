...
Version  : 1.5.1
Release  : 29
URL      : https://github.com/libbpf/libbpf/archive/v1.5.1/libbpf-1.5.1.tar.gz
Source0  : https://github.com/libbpf/libbpf/archive/v1.5.1/libbpf-1.5.1.tar.gz
...
%package staticdev
Summary: staticdev components for the libbpf package.
Group: Default
Requires: libbpf-dev = %{version}-%{release}

%description staticdev
staticdev components for the libbpf package.


%prep
%setup -q -n libbpf-1.5.1
cd %{_builddir}/libbpf-1.5.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747751630
