...
Version  : 1.6.1
Release  : 31
URL      : https://github.com/libbpf/libbpf/archive/v1.6.1/libbpf-1.6.1.tar.gz
Source0  : https://github.com/libbpf/libbpf/archive/v1.6.1/libbpf-1.6.1.tar.gz
...
%prep
%setup -q -n libbpf-1.6.1
cd %{_builddir}/libbpf-1.6.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1753109186
