...
Version  : 1.2.0
Release  : 17
URL      : https://github.com/libbpf/libbpf/archive/v1.2.0/libbpf-1.2.0.tar.gz
Source0  : https://github.com/libbpf/libbpf/archive/v1.2.0/libbpf-1.2.0.tar.gz
...
%prep
%setup -q -n libbpf-1.2.0
cd %{_builddir}/libbpf-1.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1683038546
