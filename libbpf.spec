...
Source0  : https://github.com/libbpf/libbpf/archive/v1.5.0/libbpf-1.5.0.tar.gz
...
%prep
%setup -q -n libbpf-1.5.0
cd %{_builddir}/libbpf-1.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732635733
