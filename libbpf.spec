...
Version  : 0.8.0
Release  : 11
URL      : https://github.com/libbpf/libbpf/archive/v0.8.0/libbpf-0.8.0.tar.gz
Source0  : https://github.com/libbpf/libbpf/archive/v0.8.0/libbpf-0.8.0.tar.gz
...
%prep
%setup -q -n libbpf-0.8.0
cd %{_builddir}/libbpf-0.8.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652742213
...
cp %{_builddir}/libbpf-0.8.0/LICENSE.LGPL-2.1 %{buildroot}/usr/share/package-licenses/libbpf/91c66db733cf0ff2b3216ec4223b940daf6b26d4
pushd src
%make_install
popd
