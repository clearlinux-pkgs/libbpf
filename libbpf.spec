...
Source0  : https://github.com/libbpf/libbpf/archive/v1.4.6/libbpf-1.4.6.tar.gz
...
%prep
%setup -q -n libbpf-1.4.6
cd %{_builddir}/libbpf-1.4.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725404382
