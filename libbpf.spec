...
cp %{_builddir}/libbpf-0.0.9/LICENSE.LPGL-2.1 %{buildroot}/usr/share/package-licenses/libbpf/91c66db733cf0ff2b3216ec4223b940daf6b26d4
pushd src
%make_install
popd
